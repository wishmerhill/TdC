...
\Psi = 1 + \frac{1}{n +1 } \cdot \frac{\varepsilon_{c2}}{\varepsilon_c} \cdot \left( 1- \frac{\varepsilon_c}{\varepsilon_{c2}}\right)^{(n-1)} - \frac{1}{n+1} \cdot \frac{\varepsilon_{c2}}{\varepsilon_c} \\

\lambda = \frac{\frac{1}{2} - \frac{1}{\varepsilon_c} \left[ \frac{\varepsilon_{c2}}{n +1} + \frac{\varepsilon_{c2}^2}{(n+1)(n+2)} \cdot \frac{1}{\varepsilon_c} \cdot \left( 1 - \frac{\varepsilon_c}{\varepsilon_{c2}} \right)^{(n + 2)} - \frac{1}{\varepsilon_c}  \cdot \frac{\varepsilon_{c2}^2}{(n +1)(n+2)}\right]}{1 + }
