...
\begin{gather}
0 < \varepsilon_c  \leq \varepsilon_{c_2} \\ [6pt]
\Psi = 1 + \frac{1}{n +1 } \cdot \frac{\varepsilon_{c_2}}{\varepsilon_c} \cdot \left( 1- \frac{\varepsilon_c}{\varepsilon_{c_2}}\right)^{(n-1)} - \frac{1}{n+1} \cdot \frac{\varepsilon_{c_2}}{\varepsilon_c} \\
