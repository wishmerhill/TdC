...
\Psi = 1 + \frac{1}{n +1 } \cdot \frac{\varepsilon_{c_2}}{\varepsilon_c} \cdot \left( 1- \frac{\varepsilon_c}{\varepsilon_{c_2}}\right)^{(n-1)} - \frac{1}{n+1} \cdot \frac{\varepsilon_{c_2}}{\varepsilon_c} \\[10pt] \nonumber
...
\section{campo 6}
\begin{gather}
\Psi = 1- \frac{1}{n+1} \cdot \frac{\varepsilon_{c_2} }{\varepsilon_cu} \cdot \left( \frac{\varepsilon_{cs} - \varepsilon_{c_2}}{\varepsilon_{cu} - \varepsilon_{c_2}} \right)^n
\nonumber \\
\lambda = \frac
				{
